...
<html lang="id">
  <head>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCXJLWUPV5za8rLKZ8qDRD5zFywRsRjeWE&callback=initMap&language=id&region=ID"></script>
    <script>
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="?m=tempat"><span class="glyphicon glyphicon-map-marker"></span> List Stasiun</a></li>
            <li><a href="?m=galeri"><span class="glyphicon glyphicon-picture"></span> Galeri</a></li>            
            <li><a href="?m=password"><span class="glyphicon glyphicon-lock"></span> Password</a></li>
            <li><a href="aksi.php?act=logout"><span class="glyphicon glyphicon-log-out"></span> Logout</a></li>
            <?php else:?>            
            <li><a href="?m=tempat_list"><span class="glyphicon glyphicon-map-marker"></span> List Stasiun</a></li>
